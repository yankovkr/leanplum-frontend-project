...
describe('UserDetails Component', () => {
  it('renders empty state', () => {
    ...
    expect(titleElement).toHaveTextContent(
      /Please select a user to preview details/i
    );
  });

  describe('renders UserDetails correctly', () => {
    const user = {
      id: 'usr_0',
      isDeveloper: true,
      devices: 1,
    ...
    it('renders UserDetails', async () => {
      await waitFor(
        () => {
          ...
          const devicesTile =
            within(tileContainerElement).getByText(/Devices/i);
